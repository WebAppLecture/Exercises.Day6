...
\item
Der Hintergrund ist ein Farbverlauf (unten nach oben) von \hcolor{AE0} auf
\hcolor{EA0}.
\item
...
\qty{30}{px} und einem Farbverlauf von \hcolor{F00} (links oben) nach
\hcolor{00F} (rechts unten). Er hat einen dezenten Schatten und \qty{5}{px}
runde Ecken.
\item
Die notwendigen Textfelder sind speziell hervorgehoben: Der Rahmen ist dunkler
und als Hintergrund wurde \jvar{rgb(255, 20, 20)} mit einem Alpha-Wert von
\qty{10}{\%} verwendet!
\end{itemize}