...
funktionieren, sollen Sie den Beispieltext in \htag{article} durch eine Liste
(\htag{ul}) ersetzen.
\item
Fügen Sie in der Liste 3 (oder mehr) \htag{li} Elemente mit beliebigen Text
ein.
\item
...
Abstand zwischen den einzelnen \htag{li}-Elementen soll dabei immer 1em sein.
\end{itemize}